...
public class KmlStyleListAdapter extends BaseAdapter {
	...
	@Override public View getView(int position, View convertView, ViewGroup viewGroup) {
	    ...
	    if (convertView == null) {
	        ...
	        convertView = inflater.inflate(osm.custommaps.R.layout.kml_list_item, null);
	    }
	    TextView itemText = (TextView) convertView.findViewById(osm.custommaps.R.id.listItemTxt);
	    itemText.setText(item);

		ImageView img = (ImageView)convertView.findViewById(osm.custommaps.R.id.listItemImg);
