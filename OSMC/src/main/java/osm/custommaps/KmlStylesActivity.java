...
import osm.custommaps.KmlStyleActivity;
import osm.custommaps.KmlStyleListAdapter;
...
public class KmlStylesActivity extends Activity {
	...
	osm.custommaps.KmlStyleListAdapter mListAdapter;
	ListView mListView;
	...
	@Override protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(osm.custommaps.R.layout.kml_styles);
	...
	@Override public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
		...
		//inflater.inflate(osm.custommaps.R.menu.style_item_menu, menu);
	}

	@Override public boolean onContextItemSelected(MenuItem item) {
	    AdapterContextMenuInfo info = (AdapterContextMenuInfo) item.getMenuInfo();
	    switch (item.getItemId()) {
	        case osm.custommaps.R.id.style_item_menu_cut:
	...
	@Override public boolean onCreateOptionsMenu(Menu menu) {
		MenuInflater inflater = getMenuInflater();
		//inflater.inflate(osm.custommaps.R.menu.style_option_menu, menu);
		return true;
	}

	@Override public boolean onOptionsItemSelected(MenuItem item) {
		switch (item.getItemId()) {
			case osm.custommaps.R.id.style_option_menu_new:
