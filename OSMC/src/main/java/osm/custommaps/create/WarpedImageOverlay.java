...
public class WarpedImageOverlay extends Overlay {
    ...
    private List<IGeoPoint> geoPoints;
    private List<Point> screenPoints;
    private Bitmap image;
    private Paint transparency;
    private Paint pointPaint;
    private Matrix imageMatrix;
    private IGeoPoint lastDrawnLocation = null;
    private float lastDrawnZoom = -1;


    public WarpedImageOverlay(Context ctx, Bitmap image) {
        super(ctx);
        this.image = image;
        ...
        geoPoints = new ArrayList<IGeoPoint>();
    ...
    public void setTiepoints(List<Point> imagePoints, List<IGeoPoint> geoPoints) {
    ...
    public Matrix computeImageToGeoMatrix(MapView map) {
        ...
        for (int i = 0; i < 8; i += 2) {
            ...
            IGeoPoint gp = map.getProjection().fromPixels(x, y); //TODO casted to geopooint
