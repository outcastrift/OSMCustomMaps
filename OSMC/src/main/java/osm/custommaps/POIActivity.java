...
import android.widget.TextView;import osm.custommaps.MapActivity;
...
public class POIActivity extends Activity {
	...
	@Override public void onCreate(Bundle savedInstanceState) {
		...
		TextView title = (TextView)findViewById(osm.custommaps.R.id.title);
		...
		osm.custommaps.POIAdapter adapter = new osm.custommaps.POIAdapter(this, pois);
